...
local function get_groups()
  ...
  local groups = {
    ...
    NvimTreeNormal = config.transparent_mode and { fg = colors.fg1, bg = nil } or { fg = colors.fg1, bg = colors.bg0 },
    NvimTreeNormalNC = config.dim_inactive and { fg = colors.fg0, bg = colors.bg1 } or { link = "Normal" },
    ...
    NotifyBackground = { bg = colors.bg1 },
